  ...
  export class OtpParameters extends pb_1.Message {
    ...
    get digits() {
      return pb_1.Message.getFieldWithDefault(
        this,
        5,
        MigrationPayload.DigitCount.DIGIT_COUNT_UNSPECIFIED
      ) as MigrationPayload.DigitCount;
    }
    ...
    get type() {
      return pb_1.Message.getFieldWithDefault(
        this,
        6,
        MigrationPayload.OtpType.OTP_TYPE_UNSPECIFIED
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.algorithm != MigrationPayload.Algorithm.ALGORITHM_UNSPECIFIED) writer.writeEnum(4, this.algorithm);
      if (this.digits != MigrationPayload.DigitCount.DIGIT_COUNT_UNSPECIFIED) writer.writeEnum(5, this.digits);
      if (this.type != MigrationPayload.OtpType.OTP_TYPE_UNSPECIFIED) writer.writeEnum(6, this.type);
